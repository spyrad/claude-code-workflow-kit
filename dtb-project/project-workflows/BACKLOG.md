...
|---------|--------|------|-------|--------------|
| Pipeline-Kante worker→checkpoint reziprok | Offen | Mittel | features/pipeline-kante-worker-checkpoint/task.md | dtb:worker in die after-Liste von dtb:workflow-checkpoint aufnehmen (INBOX #58 Fall 2), Reziprozitaet per Grep belegen |
