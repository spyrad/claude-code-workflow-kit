...
|---------|--------|------|-------|--------------|
| Lesestand-Pruefung ls portabel | Offen | Niedrig | features/lesestand-ls-portabel/task.md | ls -la → ls -l in den zwei gespiegelten Lesestand-Pruefungs-Bloecken (GNU-only-Finding) |
| archive 4d/4e Archiv-Realitaet | Offen | Mittel | features/archive-4d-realitaet/task.md | 4d: archivierte Items aus JEDEM Abschnitt entfernen; 4e: Zeilen aus Status-Tabelle entfernen, Warnung nur bei faelschlich In Arbeit (INBOX #65, Option 1) |
