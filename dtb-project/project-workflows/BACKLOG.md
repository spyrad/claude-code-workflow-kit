...
**Letzte Aktualisierung:** 2026-07-13 (S7: Greenfield-Autoren-Skills geplant — plan.md erstellt + Review REVISE eingearbeitet)
...
| Greenfield-Autoren-Skills | Geplant | Hoch | features/greenfield-autoren-skills/spec.md | greenfield-prd/-roadmap werden Autoren-Skills (PRD-Interview → PRD-MVP.md, Lean-Roadmap → ROADMAP.md + TECH-STACK.md) nach 10x-Vorbild, Derived-State-konform |
