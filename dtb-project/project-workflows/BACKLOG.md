...
| autonome-schiene | Abgenommen | Hoch | features/autonome-schiene/spec.md | Leichtgewichtige Lane: erkennt worker-taugliche INBOX-Eintraege (Urteil + Abhaengigkeiten + Reihenfolge + Vorab-Fragen) und arbeitet freigegebene Eintraege im Hintergrund autonom bis zur Abnahmereife ab — Freigabe und Abnahme bleiben beim Menschen (INBOX #43, zusammengelegt mit ex-#49) |
