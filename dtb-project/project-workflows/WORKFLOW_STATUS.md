...
|----------|------|
| **Blocker** | Keine |
| **Notizen** | SPEC_HAERTUNG (Idee #5) 9/9, global installiert (Lock `ff0d688`/`7554e8d`), pitch-coach bewusst übersprungen (#8/#10). Lektion L1 erfasst (`lessons.md`, gitignoriert). `/dtb:archive` bewusst zurückgestellt — beide Features erst praxiserproben. Neue Ideen #11 (greenfield-Redesign) + #12 (Eligibility-Gates) |
...
- [ ] SPEC_HAERTUNG praxiserproben (echtes feature-plan mit Lint), dann abnehmen + archivieren — Kontext: `FEATURE_SPEC_HAERTUNG.md`
...
|-------|-------------|----------|---------|
| 2026-07-09 | SPEC_HAERTUNG umgesetzt | 9/9, Abnahme PASS, global installiert (Lock `7554e8d`) | `2026-07/2026-07-09.md` (Session 2/3) |
