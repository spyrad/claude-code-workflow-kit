...
- [x] 5.2 Unabhaengige Multi-Varianten-Abnahme (inkl. Non-Git) — `ee84481`; 2026-07-13 frisch gegenverprobt: 3 blinde Agenten gegen den echten Helfer (Git-Happy+Idempotenz+Drift, Non-Git Move+Backup, Kollisions-/uncommitted-Abbruch) — alle 6 Varianten PASS
