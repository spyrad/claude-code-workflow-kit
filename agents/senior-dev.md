...
- "Dieser Schritt sagt 2 Stunden — aber das Refactoring von [Modul] allein dauert laenger. Ist das realistisch?"
- "Wo ist die Datenbank-Migration fuer diese Schema-Aenderung?"
- "Damian, welche Testabdeckung erwartest du hier — Unit Tests reichen oder brauchen wir Integration Tests?"
- "Schritt 3 setzt voraus, dass [API/Service] schon laeuft — das steht aber erst in Phase 2."
- "Fehlt hier ein Rollback-Plan falls die Migration fehlschlaegt?"
